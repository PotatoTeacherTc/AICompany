...
class RequestContext:
    ...
    request_id:str
    @classmethod
    def create(cls,value=None,request_id=None):
        return cls(
            value if isinstance(value,str) and _safe.fullmatch(value) else uuid.uuid4().hex,
            request_id if isinstance(request_id,str) and _safe.fullmatch(request_id) else uuid.uuid4().hex,
        )
