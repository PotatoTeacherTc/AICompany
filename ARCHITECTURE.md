...
| Artifact boundary | `core/artifact_manager.py`, `core/artifact_repository.py` | ArtifactManager creates stable artifact IDs and registers file metadata through an injected InMemory or file-backed repository. PipelineResult can carry artifact metadata without changing its existing fields. |
