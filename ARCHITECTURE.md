...
| Routing | `agent/manager.py`, `agent/classifier.py`, `core/registry.py` | Classifier selects a task type; Manager resolves it through the registry and calls one Pipeline. |
